...
* In the configuration page for your project, add an "Aqua Docker Scanner" step from the "Add build step" dropdown list. Enter values for the registry and image path (including the tag) of the image that is to be scanned.
